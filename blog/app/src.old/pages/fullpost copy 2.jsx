    ...
    if (provider) {
      ...
      const getPostAndAuthor = async () => {
        try {
          ...
          console.log("This is the program ID  " + program.programId.toString())
          const postAccount = new PublicKey(id);
          console.log("this is the postAccount pubkey  "+ postAccount.toString())
          const fetchedPost = await program.account.postState.fetch(postAccount);
          setPost(fetchedPost);
          console.log(fetchedPost)
          const userPublicKey = fetchedPost.user;
          console.log("User Public Key:", userPublicKey.toString());

          console.log(fetchedPost.id)
         

          // Fetch the author's data
          const authorKey = new PublicKey(fetchedPost.user);
          console.log("This is the author/user pda  " + authorKey)
